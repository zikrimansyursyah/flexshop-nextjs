    ...
    <>
      <nav className="fixed w-screen flex flex-col gap-6 px-10 pt-6 bg-gray-200 duration-500 z-20">
        <div className="navbar w-full h-full flex gap-3 xl:gap-6">
          ...
          <div className="bg-white w-5/12 rounded-xl flex flex-grow items-center px-6 justify-between border border-gray-200 shadow-lg">
          ...
          <a className="w-1/12 bg-gray-700 text-white font-medium flex items-center justify-center rounded-xl hover:scale-110 transition duration-500 ease-in-out hover:shadow-lg cursor-pointer">
            Catalog
          </a>
          ...
          {Logged.auth ? (
            <div className="w-2/12 bg-white rounded-xl flex">
              <p className="flex-grow flex items-center justify-center font-semibold text-xs lg:text-xl">
                {Logged.user}
              </p>
              <a
                className="w-14 flex flex-col justify-center items-center border-l cursor-pointer"
                onClick={() => {
                ...
                {UserMenu ? (
                  <div className="fixed w-2/12 h-20 mt-40 mr-28 lg:mr-36 xl:mr-44 2xl:mr-60">
                    <div className="w-full py-5 px-4 bg-white rounded-lg shadow-lg">
                      <a
                        className="w-full mb-5 flex gap-5 p-2 rounded-lg hover:bg-red-50"
                        onClick={() => {
                      ...
                      <a
                        className="w-full flex gap-5 p-2 rounded-lg hover:bg-red-50"
                        onClick={() => {
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="h-6 w-6 hidden xl:block text-red-500"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
        ...
        <div className="top-frame w-full h-7 bg-white rounded-t-3xl"></div>
      </nav>
      {OpenAuthModal ? (
